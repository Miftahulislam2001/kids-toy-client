...
const NavBer = () => {
    ...
    return (
        <nav className='flex max-w-[1240px] mx-auto justify-between items-center m-3 shadow py-5'>
            ...
            <ul className={`font-bold mx-3 flex items-center duration-300 flex-col py-5 md:p-0 text-white bg-opacity-90 md:text-black top-20 bg-black md:bg-transparent w-full md:w-auto md:flex-row gap-6 absolute md:static z-50 ${toggle ? "left-0" : "-left-full"}`} >
