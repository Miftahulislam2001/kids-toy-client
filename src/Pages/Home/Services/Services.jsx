    ...
    return (
        <div  className="flex flex-col items-center justify-center my-4">
            ...
            <div className="md:h-48 grid md:grid-cols-4 justify-center gap-14 items-center text-center">
                ...
                <div className="flex gap-3">
                    <div><img className="w-20 h-16" src="/service/payment.png" alt="" /></div>
                    <div>
                ...
                <div className="flex gap-3">
                    <div><img className="w-20 h-16" src="/service/help.png" alt="" /></div>
                    <div>
                ...
                <div className="flex gap-3">
                    <div><img className="w-20 h-16" src="/service/delivery.png" alt="" /></div>
                    <div>
